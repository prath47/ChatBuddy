...
const EditUserDetails = ({ onClose, user }) => {
  ...
  return (
    <div
      className="fixed top-0 bottom-0 right-0 left-0 bg-gray-700 bg-opacity-30 flex justify-center items-center z-10"
        ...
        <form className="grid gap-3 mt-3">
          ...
          <div>
            ...
            <div className="my-1 flex items-center gap-4">
              ...
              <label htmlFor="profile_pic">
                <button className="font-bold" onClick={handleOpenUploadPhoto}>
                  Change Photo
                </button>
                <input
                  ref={uploadPhotoRef}
          ...
          <div className="flex gap-2 w-fit ml-auto">
            ...
            <button
              ...
              id="submitButton"
              className="border-primary bg-primary border px-4 text-white py-1 rounded hover:bg-white hover:text-primary"
            >
              Save
            </button>
          </div>
